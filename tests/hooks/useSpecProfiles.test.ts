...
beforeEach(async () => {
  ...
  await db.specProfiles.bulkAdd([
    { subject: "通用", name: "简短", tone: "口语", styleNote: "", segments: [], opening: "", ending: "", lockedFields: [], isBuiltin: true, createdAt: 1 },
    { subject: "通用", name: "正式", tone: "正式书面", styleNote: "", segments: [], opening: "", ending: "", lockedFields: [], isBuiltin: true, createdAt: 2 },
    { subject: "数学", name: "数学专用", tone: "半书面", styleNote: "", segments: [], opening: "", ending: "", lockedFields: [], isBuiltin: false, createdAt: 3 },
  ]);
});
